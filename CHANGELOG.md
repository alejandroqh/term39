...
- **Shell lookup**: Search for shell binary in `$PATH` instead of requiring an absolute path ([#11](https://github.com/alejandroqh/term39/pull/11)) contributed by @kevingosse
...
[1.5.1]: https://github.com/alejandroqh/term39/releases/tag/v1.5.1
